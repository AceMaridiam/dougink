...
// Create 40 Word Callback for Custom Post Excerpts, call using html5wp_excerpt('custom_post');
...
add_action('init', 'create_post_type_html5'); // Add our Art Piece Type
...
function create_post_type_html5()
{
    ...
    register_post_type('html5-blank', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('New Art Piece', 'html5blank'), // Rename these to suit
            'singular_name' => __('New Art Piece', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Art Piece', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Art Piece', 'html5blank'),
            'new_item' => __('New Art Piece', 'html5blank'),
            'view' => __('View Art Piece', 'html5blank'),
            'view_item' => __('View Art Piece', 'html5blank'),
            'search_items' => __('Search Art Piece', 'html5blank'),
            'not_found' => __('No Art Pieces found', 'html5blank'),
            'not_found_in_trash' => __('No Art Pieces found in Trash', 'html5blank')
        ),
        'public' => true,
